...
export class ApiService {
  ...
  getProductById(id: string | number): Observable<any> {
    ...
    return this.http
      .get(`${this.apiUrl}/items/${id}`, { headers })
      .pipe(catchError((error: HttpErrorResponse) => this.handleError(error)));
  }
  ...
  delProductById(id: string | number): Observable<void> {
    ...
    return this.http
      .delete<void>(`${this.apiUrl}/items/${id}`, { headers })
      .pipe(catchError((error: HttpErrorResponse) => this.handleError(error)));
  }
  ...
  createProduct(data: Product): Observable<any> {
    ...
    return this.http
      .post(`${this.apiUrl}/items`, jsonData, { headers })
      .pipe(catchError((error: HttpErrorResponse) => this.handleError(error)));
  }
  ...
  updateProduct(id: number | string, data: Product): Observable<any> {
    ...
    return this.http
      .patch(`${this.apiUrl}/items/${id}`, jsonData, { headers })
      .pipe(catchError((error: HttpErrorResponse) => this.handleError(error)));
  }
